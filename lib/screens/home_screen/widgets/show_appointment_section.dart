...
Widget showAppointmentSection({context}) {
  ...
  return Padding(
    ...
    child: Stack(
      children: [
        gradientRoundedContainer( //blue container
          context: context,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.only(left: containerHorPadd,bottom: containerVerPadd),
                child: Row(
        ...
        Positioned(//call button
          ...
          child: CircleAvatar(
            ...
            child: GestureDetector(
              onTap: (){},
              child: gradientRoundedContainer(context:context,borderRadius: largeBorderRadius,
                  child: Icon(Icons.call,color: white,),blur: 12.0 ),
            ),
          ),
        )
